 ...
 *
 */
public class MainFragment_4_kcb extends BaseFragment {
    ...
    protected int setLayoutResourceID() {
        return R.layout.fragment_main_4_kcb;
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.btn_xiugai:
                ((MainFragment_4)getBaseParentFragment(4)).setInitView(MainFragment_4.MAIN_FRAGMENT_INDEX_KCBK,"课程备课");
                break;
            case R.id.iv_you:
