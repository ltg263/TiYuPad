...
public class MainAdapter_2_bjcj extends BaseQuickAdapter<String, BaseViewHolder> {


    public MainAdapter_2_bjcj(@Nullable List<String> data) {
        super(R.layout.item_main_2_bjcj, data);
    }
