...
public class MainAdapter_2_xscj extends BaseQuickAdapter<String, BaseViewHolder> {


    public MainAdapter_2_xscj(@Nullable List<String> data) {
        super(R.layout.item_main_2_xscj, data);
    }
