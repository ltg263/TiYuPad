...
public class MainAdapter_2_xljl_td extends BaseQuickAdapter<String, BaseViewHolder> {


    public MainAdapter_2_xljl_td(@Nullable List<String> data) {
        super(R.layout.item_main_2_xljl_td, data);
    }
