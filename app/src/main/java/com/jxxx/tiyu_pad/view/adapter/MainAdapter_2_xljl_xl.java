...
public class MainAdapter_2_xljl_xl extends BaseQuickAdapter<String, BaseViewHolder> {


    public MainAdapter_2_xljl_xl(@Nullable List<String> data) {
        super(R.layout.item_main_2_xljl_xl, data);
    }
