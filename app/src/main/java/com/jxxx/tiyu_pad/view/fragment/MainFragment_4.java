...
public class MainFragment_4 extends BaseFragment {

    TextView tv_title_name;
    LinearLayout ll_back;
    List<String> listTitle = new ArrayList<>();
    List<String> listTitleIndex = new ArrayList<>();
    public static int MAIN_FRAGMENT_INDEX_KCBK= 1;
    public static int MAIN_FRAGMENT_INDEX_KCB= 2;
    @Override
    ...
    protected void initView() {
        ...
        setInitView(MAIN_FRAGMENT_INDEX_KCBK,"课程备课");
    }
    ...
    private void intentGoFragment(int index,String title,FragmentTransaction fragmentTransaction) {
        if(index == MAIN_FRAGMENT_INDEX_KCBK) {
            fragmentTransaction.replace(R.id.deliver_frame, new MainFragment_4_kcbk());
        }else if(index == MAIN_FRAGMENT_INDEX_KCB){
            fragmentTransaction.replace(R.id.deliver_frame, new MainFragment_4_kcb());
        }
