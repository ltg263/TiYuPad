...
public class MainFragment_6 extends BaseFragment {
    ...
    protected void initView() {
        ...
        setInitView(MAIN_FRAGMENT_INDEX_SBGL,"设备管理");
    }
    ...
    private void intentGoFragment(int index,String title,FragmentTransaction fragmentTransaction) {
        if(index == MAIN_FRAGMENT_INDEX_SBGL) {
            fragmentTransaction.replace(R.id.deliver_frame, new MainFragment_6_sbgl());
        }
